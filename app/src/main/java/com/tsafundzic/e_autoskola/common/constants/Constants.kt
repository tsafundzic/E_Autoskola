package com.tsafundzic.e_autoskola.common.constants

const val CANDIDATE: String = "candidate"
const val INSTRUCTOR: String = "instructor"
const val ROLE: String = "role"
const val USERS: String = "users"
const val SCHOOLS: String = "schools"

const val ADDRESS: String = "address"
const val NAME: String = "name"
const val BIRTHDATE: String = "birthdate"
const val EMAIL: String = "email"
const val OIB: String = "oib"
const val SELECTEDSCHOOL: String = "selectedSchool"
